...
gulp.task( 'vendorsJs', function() {
	...
	gulp.src( [
		'./assets/js/vendors/jquery.columnizer.js',
		'./assets/js/vendors/query.easing.1.3.js',
		'./assets/js/vendors/jquery.galleriffic.js',
		'./assets/js/vendors/jquery.history.js',
		'./assets/js/vendors/jquery.opacityrollover.js',
		'./assets/js/vendors/isotope-scripts.js',
		'./assets/js/vendors/isotope-plugins.js'
